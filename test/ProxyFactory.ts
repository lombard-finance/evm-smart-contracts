...
describe("ProxyFactory", () => {
    ...
    it("should create a proxy", async () => {
        ...
        await proxyFactory.createTransparentProxy(await lbtcImplementation.getAddress(), deployer.address, data, salt);
        ...
        await proxyFactory.createTransparentProxy(await wbtcMockImplementation.getAddress(), deployer.address, data, salt);
