        ...
        describe('With whitelisted minter', function () {
            ...
            it('should allow swaps', async function () {
                ...
                await expect(
                    pmm
                        .connect(signer1)
                        .swapCBBTCToLBTC(ethers.parseUnits('11', 8))
                )
            ...
            it('should fail to swap more than limit', async function () {
                await cbbtc
                    ...
                    .approve(
                        await pmm.getAddress(),
                        ethers.parseUnits('130', 8)
                    );
                await expect(
                    pmm
                        .connect(signer1)
                        .swapCBBTCToLBTC(ethers.parseUnits('130', 8))
            ...
            it('should allow more swaps if limit is increased', async function () {
                ...
                await pmm
                    .connect(signer1)
                    .swapCBBTCToLBTC(ethers.parseUnits('30', 8));
                expect(await pmm.remainingStake()).to.equal(0);

                await pmm
                    .connect(operator)
                    .setStakeLimit(ethers.parseUnits('40', 8));
                ...
                await pmm
                    .connect(signer2)
                    .swapCBBTCToLBTC(ethers.parseUnits('10', 8));
                expect(await pmm.remainingStake()).to.equal(0);
            });
            ...
            it('should have zero remaining stake if total stake is greater than limit', async function () {
                ...
                await pmm
                    .connect(operator)
                    .setStakeLimit(ethers.parseUnits('20', 8));
                expect(await pmm.remainingStake()).to.equal(0);
            });
