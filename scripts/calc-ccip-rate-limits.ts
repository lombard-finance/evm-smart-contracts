...
async function calcCcipRateLimits(chainSelector: bigint, requestTokens: bigint): Promise<boolean> {
  const tokenPool = await ethers.getContractAt('LombardTokenPool', '0x84166eAf4530994C565E6aCC774a6950Ce8c88aA');
...
async function main() {
  const belowLimit = await calcCcipRateLimits(5009297550715157269n, 50000000n);
